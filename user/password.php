...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 require ('../includes/connect.php'); // Connect to the db.
...
// Check that they've entered the right email address/password combination:
 $q = "SELECT user_id FROM user WHERE (email='$e' AND password=SHA1('$p') )";
...
// Make the UPDATE query:
 $q = "UPDATE user SET password=SHA1('$np') WHERE user_id =".$row['user_id'];
 $r = @mysqli_query($dbc, $q);
